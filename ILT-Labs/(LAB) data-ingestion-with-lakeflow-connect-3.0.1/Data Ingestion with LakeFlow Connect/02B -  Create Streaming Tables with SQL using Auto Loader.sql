...
FROM STREAM read_files(
  '/Volumes/dbacademy/labuser11027157_1753595201/csv_files_autoloader_source',
    -- Insert the path to you csv_files_autoloader_source volume (example shown)
  format => 'CSV',
  sep => '|',
  header => true
);
...
-- MAGIC %python
-- MAGIC dbutils.fs.cp('/Volumes/dbacademy/labuser11027157_1753595201/auto_loader_staging_files/001.csv','/Volumes/dbacademy/labuser11027157_1753595201/csv_files_autoloader_source/001.csv')
...
use dbacademy.labuser11027157_1753595201;
