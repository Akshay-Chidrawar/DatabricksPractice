...
INSERT INTO hive_metastore.hr_db.employees VALUES 
(1, "Anna", 2500, "Paris"),
...
AS 
SELECT * 
FROM  hive_metastore.hr_db.employees 
WHERE city = 'Paris';
...
GRANT USAGE ON DATABASE hive_metastore.hr_db TO hr_team;
